            ...
            <div className="w-full flex items-center justify-center py-20 my-12">
                <div className=" top-40 bg-white shadow rounded py-12 lg:px-28 px-8">
                    ...
                    <div className="flex items-center justify-center w-full">
                        <button className="btn mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-indigo-700 rounded hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none " disabled={!disable}>SUBMIT</button>
