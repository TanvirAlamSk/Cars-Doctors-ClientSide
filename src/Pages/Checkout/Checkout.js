...
const Checkout = () => {
    const countries = ["United State", "Pakistan", "India", "China", "Russia", "UK"];
                ...
                <div className="flex flex-col justify-start items-start w-full space-y-9">
                    ...
                    <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
                        ...
                        <div className="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
                            ...
                            <div className="mt-8">
                                <input className="border border-gray-300 p-4 rounded w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="email" readOnly defaultValue={user?.email} placeholder="Email" />
                            </div>
